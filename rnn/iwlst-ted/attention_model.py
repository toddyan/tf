    ...
    def forward(self, src_input, src_size, trg_input, trg_label, trg_size):
        ...
        with tf.variable_scope("decoder"):
            ...
            dec_outputs, _ = tf.nn.dynamic_rnn(
                ...
                initial_state=None,  # initial_state is not used in attention rnn
                dtype=tf.float32
            )
    ...
    def infer(self, src_input):
        ...
        with tf.variable_scope("decoder/rnn/attention_wrapper"):
            ...
            def loop_body(prev_step_state, dec_ids, step):
                ...
                cur_step_ouputs, cur_step_state = attention_cell.call(
            ...
            init_state = attention_cell.zero_state(dtype=tf.float32, batch_size=1)
            dec_state, dec_ids, step = tf.while_loop(
                cond=loop_cond,
                body=loop_body,
                loop_vars=(init_state, dec_ids, 0)
            )
            return dec_ids.stack()

        # with tf.variable_scope("decoder/rnn/attention_wrapper/multi_rnn_cell"):
